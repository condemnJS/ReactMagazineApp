...
export const FETCH_DELETE_SUBCATEGORY = "FETCH_DELETE_SUBCATEGORY"

// Удалить подподкатегирию
export const DELETE_SUBSUBCATEGORY = "DELETE_SUBSUBCATEGORY"
export const FETCH_DELETE_SUBSUBCATEGORY = "FETCH_DELETE_SUBSUBCATEGORY"
